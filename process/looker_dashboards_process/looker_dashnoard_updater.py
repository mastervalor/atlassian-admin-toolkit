...
csv_logic = CSVLogic(open_file='looker dashboards', write_file='looker dashboards updater')
...
dashboards_info = dashboard_logic.get_dashboard_updaters(dashboards_ids)
